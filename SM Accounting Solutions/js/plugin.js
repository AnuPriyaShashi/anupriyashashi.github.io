$(document.getElementsByClassName("happy-client")).ready(function() {
    $(".happy-client").circularProgress({
        line_width: 6,
        color: "#249e85",
        ...
        percentage: true,
        text: "Happy Client"
    }).circularProgress('animate', 40, 5000);
});

$(document.getElementsByClassName("sad-client")).ready(function() {
    $(".sad-client").circularProgress({
        line_width: 6,
        color: "#249e85",
        starting_position: 0, // 12.00 o' clock position, 25 stands for 3.00 o'clock (clock-wise)
        percent: 0, // percent starts from
        percentage: true,
        text: "Sad Client"
    }).circularProgress('animate', 20, 5000);
});
(function ( $ ) {
    ...
    var methods = {
        init : function(options) {
            ...
            // Create percentage
            var percentage = $("<div class='progressPercentage'></div>");
            ...
            // Create text
            var text = $("<div class='progressText'></div>");
            ...
            $(this).addClass("circularProgressBar");
    ...
    function insertText(scope) {
        $(".progressPercentage").text(Math.round(global_settings.percent) + "%");
    }
    // create canvas
